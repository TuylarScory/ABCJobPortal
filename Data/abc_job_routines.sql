...
--
-- Dumping events for database 'abc_job'
--

--
-- Dumping routines for database 'abc_job'
--
/*!50003 DROP PROCEDURE IF EXISTS `numberOfAdmin` */;
...
/*!50003 DROP PROCEDURE IF EXISTS `select_User_Data` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
-- Dump completed on 2020-10-20 22:19:57
